...
Instead of reproducing the original DiT, this work focuses on designing and comparing different conditioning strategies that enable the model to generate realistic shoe images from edge sketches.
